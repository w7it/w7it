...
export const Roadmap: React.FC = () => {
    ...
    useEffect(() =>
        api.subscribeDOB((dob) => {
            ...
            setCurrentWeek(
                years * WEEKS +
                    Math.ceil((Date.now() - lastDOB.getTime()) / (7 * 24 * 60 * 60 * 1000)),
            );
        }),
    );
        ...
        <RoadmapContextProvider value={api}>
            <div className="container mx-auto overflow-x-hidden mt-4 p-8">
                ...
                <p className="text-xl mt-2">
                    Это веб-версия карты жизни. Тут представлены {YEARS} лет, разбитые на {WEEKS}{' '}
                    ячейки. 1 ячейка - 1 неделя. Все данные хранятся локально и в самой ссылке.
                </p>
