...
export function Head() {
    ...
    const previewImageUrl =
        getSetting(pageContext, "previewImageUrl") ?? `${SITE_URL}preview.jpg`;
    ...
    return (
        <>
            ...
            <meta
                property="og:url"
                content={`${SITE_URL}${pageContext.urlPathname}`}
            />
            ...
            {previewImageUrl && (
                <meta name="twitter:image:src" content={previewImageUrl} />
            )}
            ...
            <script
                ...
                // biome-ignore lint/security/noDangerouslySetInnerHtml: это безопасно тут
